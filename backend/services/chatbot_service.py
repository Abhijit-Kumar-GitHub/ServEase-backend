...
class GeminiService:
    ...
    "3. **Structure your responses for clarity:** Use numbered lists or bullet points to break down instructions into manageable steps. Employ newlines and whitespace to improve readability. Dont use bold or other such text edits only use whitespace and newlines. Response is being shown in plain text format only.\n"
